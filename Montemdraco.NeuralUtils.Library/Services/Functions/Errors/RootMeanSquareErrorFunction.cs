...
{
    /// <summary>
    /// Подкоренная среднеквадратическая ошибка.
    /// </summary>
    public class RootMeanSquareErrorFunction : IErrorFunction
    {
        /// <inheritdoc />
        public string Name => "RootMSE";
        ...
        public double Calculate(NeuralOutputData expected, NeuralOutputData obtained)
        {
            ...
            return Math.Sqrt(result / expectedCount);
        }
    }
}
